...
Defined in: [src/screens/Leaderboard/Leaderboard.mocks.ts:191](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/screens/Leaderboard/Leaderboard.mocks.ts#L191)
