...
Defined in: [src/screens/OrgPost/OrgPostMocks.data.ts:104](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/screens/OrgPost/OrgPostMocks.data.ts#L104)
