...
Defined in: [src/components/Venues/VenueCardMocks.ts:26](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/Venues/VenueCardMocks.ts#L26)
