...
Defined in: [src/components/AgendaItems/AgendaItemsMocks.ts:216](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/AgendaItems/AgendaItemsMocks.ts#L216)
