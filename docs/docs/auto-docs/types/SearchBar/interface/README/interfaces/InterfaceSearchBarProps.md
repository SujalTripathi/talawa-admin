...
[`InterfaceSearchMeta`](types\SearchBar\interface\README\interfaces\InterfaceSearchMeta.md)
...
> `optional` **size**: [`SearchBarSize`](types\SearchBar\type\README\type-aliases\SearchBarSize.md)
...
> `optional` **variant**: [`SearchBarVariant`](types\SearchBar\type\README\type-aliases\SearchBarVariant.md)
